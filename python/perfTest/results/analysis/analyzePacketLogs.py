...
#instead of work w/ CSV in python, we've inserted into mongodb from CSV:
...
# change dbName in config.py to match intended data set
...
# see how many COs were prepared signed on interface
#results = data.getInterfaceSigned()
#print("there are "+str(results.count())+" content objects prepared & signed on interface")


# let's see how many made it back to controller
# deriving final content objects two ways to be sure
